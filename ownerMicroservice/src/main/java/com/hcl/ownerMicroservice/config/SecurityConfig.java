...
//
//    private static final String[] AUTHENTICATION_WHITE_LISTED = { "/hello", "/api/rentAPLace/v1/owner/*",
//            "/api/rentAPLace/v1/properties/*",
...
//                .requestMatchers("/api/rentAPLace/v1/owner/**","/api/rentAPLace/v1/properties/**")
//                .authenticated()
//                .and()
//                //.formLogin()
//                .httpBasic()
